...
Begin Window Window_Dose_Info
   ...
   Placement       =   0
   Resizeable      =   False
   Title           =   "Dose Distribution Information"
   Visible         =   True
   Width           =   634
   Begin GroupBox GroupBox1
      AutoDeactivate  =   True
      Bold            =   False
      Caption         =   "Dose Properties"
      Enabled         =   True
      Height          =   327
      HelpTag         =   ""
      Index           =   -2147483648
      ...
      Begin Label StaticText3
         ...
         Width           =   100
      End
      Begin TextField EditField_1stx_BL
         AcceptTabs      =   False
         Alignment       =   0
         AutoDeactivate  =   True
         ...
         Width           =   100
      End
      Begin TextField EditField_LastX
         AcceptTabs      =   False
         Alignment       =   0
         AutoDeactivate  =   True
         AutomaticallyCheckSpelling=   False
      ...
      Begin Label StaticText1
         ...
         Width           =   84
      End
      Begin TextField EditField_1stY_BL
         AcceptTabs      =   False
         Alignment       =   0
         AutoDeactivate  =   True
         AutomaticallyCheckSpelling=   False
      ...
      Begin Label StaticText2
         ...
         Width           =   100
      End
      Begin TextField EditField_1stZ_BL
         AcceptTabs      =   False
         Alignment       =   0
         AutoDeactivate  =   True
         AutomaticallyCheckSpelling=   False
      ...
      Begin TextField EditField_dy
         ...
         Width           =   101
      End
      Begin TextField EditField_LastY
         AcceptTabs      =   False
         Alignment       =   0
         AutoDeactivate  =   True
         AutomaticallyCheckSpelling=   False
      ...
      Begin TextField EditField_ny
         ...
         Width           =   101
      End
      Begin TextField EditField_lastZ
         AcceptTabs      =   False
         Alignment       =   0
         AutoDeactivate  =   True
         AutomaticallyCheckSpelling=   False
      ...
      Begin Label StaticText16
         ...
         Width           =   100
      End
      Begin TextField EditField_lastZ_BL
         AcceptTabs      =   False
         Alignment       =   0
         AutoDeactivate  =   True
         AutomaticallyCheckSpelling=   False
         ...
         Width           =   109
      End
      Begin TextField EditField_LastY_BL
         AcceptTabs      =   False
         Alignment       =   0
         AutoDeactivate  =   True
         AutomaticallyCheckSpelling=   False
         ...
         Width           =   101
      End
      Begin TextField EditField_LastX_BL
         AcceptTabs      =   False
         Alignment       =   0
         AutoDeactivate  =   True
         AutomaticallyCheckSpelling=   False
      ...
      Begin Label StaticText18
         ...
         Width           =   100
      End
      Begin TextField EditField_1stZ
         AcceptTabs      =   False
         Alignment       =   0
         AutoDeactivate  =   True
         AutomaticallyCheckSpelling=   False
         ...
         Width           =   109
      End
      Begin TextField EditField_1stY
         AcceptTabs      =   False
         Alignment       =   0
         AutoDeactivate  =   True
         AutomaticallyCheckSpelling=   False
         ...
         Width           =   101
      End
      Begin TextField EditField_1stx
         AcceptTabs      =   False
         Alignment       =   0
         AutoDeactivate  =   True
         AutomaticallyCheckSpelling=   False
   ...
   Begin PushButton PushButton_save
      ...
      Width           =   170
   End
   Begin TextField EditField_Dose_SOP
      AcceptTabs      =   False
      Alignment       =   0
      AutoDeactivate  =   True
      AutomaticallyCheckSpelling=   False
   ...
   Begin Label StaticText17
      ...
      Width           =   85
   End
   Begin TextField EditField_Dose_units
      AcceptTabs      =   False
      Alignment       =   0
      AutoDeactivate  =   True
      AutomaticallyCheckSpelling=   False
      ...
      Width           =   368
   End
   Begin TextField EditField_Dname
      AcceptTabs      =   False
      Alignment       =   0
      AutoDeactivate  =   True
      AutomaticallyCheckSpelling=   False
   ...
   Begin Label StaticText12
      ...
      Width           =   85
   End
   Begin TextField EditField_Dose_Comments
      AcceptTabs      =   False
      Alignment       =   0
      AutoDeactivate  =   True
      AutomaticallyCheckSpelling=   False
   ...
   Begin Label StaticText1711
      ...
      Width           =   115
   End
   Begin TextField EditField_Dose_Type
      AcceptTabs      =   False
      Alignment       =   0
      AutoDeactivate  =   True
      AutomaticallyCheckSpelling=   False
   ...
   Begin Label StaticText171111
      ...
      Width           =   115
   End
   Begin TextField EditField_Dose_Engine
      AcceptTabs      =   False
      Alignment       =   0
      AutoDeactivate  =   True
      AutomaticallyCheckSpelling=   False
      ...
      Width           =   338
   End
   Begin TextField EditField_Dose_Series
      AcceptTabs      =   False
      Alignment       =   0
      AutoDeactivate  =   True
      AutomaticallyCheckSpelling=   False
	...
	#tag Event
		Sub Open()
		  ...
		  if UBound(gRTOG.Plan(Plan_Index).Dose)>= Window_Treatment.dose_index and Window_Treatment.dose_index>-1  Then
		    ...
		    x=dd.Coord_1_1st_point
		    y=dd.Coord_2_1st_point
...
#tag Events PushButton_save
	#tag Event
		Sub Action()
		  ...
		  //--------------------------------------
		  DIm i,x AS Integer
		  Dim zz,zone as Single
		  Dim dd,ddnew as RTOG_Dose_Distribution
		  //--------------------------------------
		  
		  dd=gRTOG.Plan(Plan_Index).Dose(Window_Treatment.dose_index)
		  
		  ddnew= new RTOG_Dose_Distribution
		  ddnew.SOP_Instance_UID=gDICOM.UID_Make
		  ReDim ddnew.Dose_Distribution(UBound(dd.Dose_Distribution))
		  
		  ddnew.Coord_1_1st_point=val(EditField_1stx.Text)
		  ddnew.Coord_2_1st_point=val(EditField_1sty.Text)
		  ddnew.Coord_3_1st_point=val(EditField_1stZ.Text)
		  ddnew.Depth_Grid=dd.Depth_Grid 
		  ddnew.Horizontal_Grid=dd.Horizontal_Grid
		  ddnew.Vertical_Grid=dd.Vertical_Grid
		  ddnew.Size_of_Dimension1=dd.Size_of_Dimension1
		  ddnew.Size_of_Dimension2=dd.Size_of_Dimension2
		  ddnew.Size_of_Dimension3=dd.Size_of_Dimension3
		  ddnew.SeriesDescription=EditField_Dose_Series.Text
		  
		  
		  zz=val(EditField_dz.Text)
		  zone=val(EditField_1stZ.Text)
		  
		  ddnew.Dmax=dd.Dmax 
		  ddnew.Dmin=dd.Dmin
		  ddnew.Dose_Units=Trim(EditField_Dose_units.Text)
		  ddnew.Dose_name=dd.Dose_name
		  ddnew.Dose_Comment=Trim(EditField_Dose_Comments.Text)
		  ddnew.SOP_Instance_UID=Trim(EditField_Dose_SOP.Text)
		  
		  
		  FOR I=0 TO UBound(dd.Dose_Distribution)
		    ddnew.Dose_Distribution(i)=new RTOG_Dose_Plane
		    
		    ReDim ddnew.Dose_Distribution(i).Points(UBound(dd.Dose_Distribution(i).Points))
		    ReDim ddnew.Dose_Distribution(i).errors(UBound(dd.Dose_Distribution(i).Errors))
		    
		    ddnew.Dose_Distribution(i).Z=zone+i*zz
		    
		    for x=0 to UBound(dd.Dose_Distribution(I).Points)
		      ddnew.Dose_Distribution(i).Points(x)=dd.Dose_Distribution(i).Points(x)
		      if UBound(dd.Dose_Distribution(i).Errors)>=i Then
		        ddnew.Dose_Distribution(i).Errors(x)=dd.Dose_Distribution(i).Errors(x)
		      end
		    next
		  next
		  
		  gRTOG.Plan(Plan_Index).Dose.append ddnew
