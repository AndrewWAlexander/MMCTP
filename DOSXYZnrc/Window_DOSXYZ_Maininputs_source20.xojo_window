#tag Window
Begin Window Window_DOSXYZ_Maininputs_source20
   BackColor       =   &cFFFFFF00
   Backdrop        =   0
   CloseButton     =   True
   Composite       =   False
   ...
   Begin Label StaticText3
      ...
      Width           =   253
   End
   Begin TextField EditField_FILNAME
      AcceptTabs      =   False
      Alignment       =   0
      AutoDeactivate  =   True
      AutomaticallyCheckSpelling=   False
   ...
   Begin Listbox Listbox_Points
      ...
      _ScrollWidth    =   -1
   End
   Begin TextField EditField_idbs
      AcceptTabs      =   False
      Alignment       =   0
      AutoDeactivate  =   True
      AutomaticallyCheckSpelling=   False
   ...
   Begin Label Label3
      ...
      Width           =   253
   End
   Begin TextField EditField_r_dbs
      AcceptTabs      =   False
      Alignment       =   0
      AutoDeactivate  =   True
      AutomaticallyCheckSpelling=   False
   ...
   Begin Label Label5
      ...
      Width           =   253
   End
   Begin TextField EditField_z_dbs
      AcceptTabs      =   False
      Alignment       =   0
      AutoDeactivate  =   True
      AutomaticallyCheckSpelling=   False
   ...
   Begin Label Label6
      ...
      Width           =   253
   End
   Begin TextField EditField_e_split
      AcceptTabs      =   False
      Alignment       =   0
      AutoDeactivate  =   True
      AutomaticallyCheckSpelling=   False
   ...
   Begin Label Label7
      ...
      Width           =   253
   End
   Begin TextField EditField_i_muidxout
      AcceptTabs      =   False
      Alignment       =   0
      AutoDeactivate  =   True
      AutomaticallyCheckSpelling=   False
...
#tag Events PushButton_Close
	#tag Event
		Sub Action()
		  Window_DOSXYZ_Maininputs_source20.Close
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events EditField_BEAM_exe
	#tag Event
		Sub TextChange()
		  dosxyz_input.the_shared_lib=me.Text
		End Sub
	#tag EndEvent
#tag EndEvents
...
#tag Events Listbox_Points
	...
	#tag EndEvent
#tag EndEvents
#tag Events EditField_idbs
	#tag Event
		Sub TextChange()
		  
		  dosxyz_input.i_dbs=val(me.Text)
		  
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events EditField_r_dbs
	#tag Event
		Sub TextChange()
...
#tag Events EditField_e_split
	...
	#tag EndEvent
#tag EndEvents
#tag Events EditField_i_muidxout
	#tag Event
		Sub TextChange()
