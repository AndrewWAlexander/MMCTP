	...
	#tag Method, Flags = &h0
		Sub Refresh_window()
		  ...
		  for i=1 to app.ISCM_MAX
		    ...
		    Listbox_Pairs.CellValueAt(1,i)=Format(app.ZMIN_JAWS(i-1),"-#.###")
		    Listbox_Pairs.CellValueAt(2,i)=Format(app.ZMAX_JAWS(i-1),"-#.###")
		    Listbox_Pairs.CellValueAt(3,i)=Format(app.XFP_JAWS(i-1),"-#.###")
		    Listbox_Pairs.CellValueAt(4,i)=Format(app.XBP_JAWS(i-1),"-#.###")
		    Listbox_Pairs.CellValueAt(5,i)=Format(app.XFN_JAWS(i-1),"-#.###")
		    Listbox_Pairs.CellValueAt(6,i)=Format(app.XBN_JAWS(i-1),"-#.###")
		    Listbox_Pairs.CellValueAt(7,i)=Format(app.ECUT_Jaws(i-1),"-#.###")
		    Listbox_Pairs.CellValueAt(8,i)=Format(app.PCUT_Jaws(i-1),"-#.###")
		    Listbox_Pairs.CellValueAt(9,i)=Format(app.Dose_zone_Jaws(i-1),"#")
		    Listbox_Pairs.CellValueAt(10,i)=Format(app.Iregion_Jaws(i-1),"#")
		    Listbox_Pairs.CellValueAt(11,i)=app.Medium_Jaws(i-1)
		...
		Sub CellTextChange(row as Integer, column as Integer)
		  if donothing=False Then
		    ...
		    if column>=1 Then
		      ...
		      elseif row=10 Then
		        app.Iregion_Jaws(column-1)=val(me.CellValueAt(row,column))
