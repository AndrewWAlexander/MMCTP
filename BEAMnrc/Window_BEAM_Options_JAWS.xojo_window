#tag Window
Begin Window Window_BEAM_Options_JAWS
   BackColor       =   &cFFFFFF00
   Backdrop        =   0
   CloseButton     =   True
   Composite       =   False
	...
	#tag Event
		Sub TextChange()
		  if donothing=False Then
		    ...
		    ReDim S.ZMAX_JAWS(S.ISCM_MAX-1)
		    ReDim S.ZMIN_JAWS(S.ISCM_MAX-1)
		    ReDim S.XFP_JAWS(S.ISCM_MAX-1)
		    ReDim S.XBN_JAWS(S.ISCM_MAX-1)
		    ReDim S.XFN_JAWS(S.ISCM_MAX-1)
		    ReDim S.XBP_JAWS(S.ISCM_MAX-1)
		    
		    ReDim S.ECUT_Jaws(S.ISCM_MAX-1)
		    ReDim S.PCUT_Jaws(S.ISCM_MAX-1)
		    ReDim S.Dose_zone_Jaws(S.ISCM_MAX-1)
		    ReDim S.Iregion_Jaws(S.ISCM_MAX-1)
...
#tag Events PushButton_Close
	#tag Event
		Sub Action()
		  Window_BEAM_Options_JAWS.Close
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events PushButton_LAYERS
	#tag Event
		Sub Action()
		  Window_BEAM_Options_JAWS_PARIS.Show
		End Sub
	#tag EndEvent
#tag EndEvents
...
#tag Events EditField_Dosezone
	#tag Event
		Sub TextChange()
		  S.Dose_zone_opening=val(me.Text)
		End Sub
	#tag EndEvent
#tag EndEvents
